...
from cinema.models import Actor, Genre, CinemaHall, MovieSession, Movie
from cinema.serializers import GenreSerializer, ActorSerializer, \
    MovieSerializer, CinemaHallSerializer, MovieListSerializer, MovieRetrieveSerializer, MovieSessionSerializer, \
