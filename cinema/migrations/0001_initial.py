# Generated by Django 4.0.4 on 2023-06-27 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='actors', to='cinema.actor')),
                ('genres', models.ManyToManyField(related_name='genres', to='cinema.genre')),
            ],
            options={
                'ordering': ['title'],
            },
